...
namespace InfogesEmape.Code.Logic.Forms.Seguimiento
{
	public class GsoProyectoRegistro
	{
        ...
        public static DataSet SearchByProyectoContrato2(string pIdProyecto)
        {
            return Code.Data.Forms.Seguimiento.GsoProyectoRegistro.SearchByProyectoContrato2(pIdProyecto);
        }
