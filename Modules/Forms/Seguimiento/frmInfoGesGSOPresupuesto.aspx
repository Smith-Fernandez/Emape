...
<CellStyle HorizontalAlign="Right"></CellStyle>
        ...
        <dx:GridViewDataTextColumn Caption="NOMBRE SUPERVISOR" FieldName="RAZON_SOCIAL_SUPERVISOR" ShowInCustomizationForm="True" VisibleIndex="6">
            <HeaderStyle Font-Bold="True" />
            <ExportCellStyle Font-Bold="True">
            </ExportCellStyle>
        </dx:GridViewDataTextColumn>
        ...
        <td><br /><br />
            ...
            <dx:ASPxGridView ID="GridContratoPartida" runat="server" AutoGenerateColumns="False" Width="100%" KeyFieldName="IDCONTRATOPARTIDA" OnLoad="OnLoadContratoPartida" OnCustomUnboundColumnData="GridContratoPartida_CustomUnboundColumnData" OnCustomSummaryCalculate="GridContratoPartida_CustomSummaryCalculate" EnableTheming="True" Theme="Glass" ClientInstanceName="GridContratoPartida" OnSummaryDisplayText="GridContratoPartida_SummaryDisplayText" OnRowUpdating="OnRowUpdatingContratoPartida" OnHtmlDataCellPrepared="GridContratoPartida_HtmlDataCellPrepared" OnHtmlRowPrepared="GridContratoPartida_HtmlRowPrepared" OnHtmlRowCreated="GridContratoPartida_HtmlRowCreated">                                       
										...
										<TotalSummary>
                                            ...
                                            <dx:ASPxSummaryItem FieldName="TOTAL" ShowInColumn="TOTAL" SummaryType="Sum" DisplayFormat=" "/>
                                ...
                                <tr>                                        
                                        <dx:ASPxGridViewExporter ID="gridExporter" runat="server" ExportedRowType="All" GridViewID="GridContratoPartida" PaperKind="A4" Landscape="True" MaxColumnWidth="1800" OnRenderBrick="gridExporter_RenderBrick">
                                            <Styles>
                                                ...
                                                <Title Font-Size="X-Large"></Title>
                                            </Styles>
                                        </dx:ASPxGridViewExporter>
                                    <dx:ASPxGridViewExporter ID="gridExporter01" runat="server" ExportedRowType="All" GridViewID="GridProyectoContrato" PaperKind="A4" Landscape="True" MaxColumnWidth="400"></dx:ASPxGridViewExporter>                                            
