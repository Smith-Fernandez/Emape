...
namespace InfogesEmape.Modules.Forms.Seguimiento
{
    public partial class frmInfoGesGsoProyectoRegistro : System.Web.UI.Page
    {
        ...
        {
            this.GridContratoPartida.Columns["APROBADO"].Visible = false;
            // PARA PONER TITULO
            ...
            compositeLink.Links.AddRange(new object[] { linkGrid1Report, link });
        ...
        {
            DataSet ds5 = new DataSet();
            ds5 = Code.Logic.Forms.Seguimiento.GsoProyectoRegistro.SearchByProyectoContrato2((string)(Session["pIdProyecto"]));
            ...
            tb.Rect = new RectangleF(0, 0,1000, 100);
            tb.BorderWidth = 0;
        ...
        void linkGrid4Report_CreateDetailArea(object sender, CreateAreaEventArgs e)
        {
            ...
            tb.Font = new Font("Arial", 8);
            tb.Rect = new RectangleF(350, 90, 500, 20);
            tb.BorderColor = Color.Transparent;
            tb.BackColor = Color.Transparent;
            tb.HorzAlignment = DevExpress.Utils.HorzAlignment.Near;
            e.Graph.DrawBrick(tb);
        ...
        void linkGrid7Report_CreateDetailArea(object sender, CreateAreaEventArgs e)
        {
            ...
            tb.Font = new Font("Arial", 8);
            tb.Rect = new RectangleF(350, 110, 500, 20);
            tb.BorderColor = Color.Transparent;
            tb.BackColor = Color.Transparent;
            tb.HorzAlignment = DevExpress.Utils.HorzAlignment.Near;
            e.Graph.DrawBrick(tb);
        ...
        protected void GridContratoPartida_SummaryDisplayText(object sender, ASPxGridViewSummaryDisplayTextEventArgs e)
        {
            ...
            {
                e.Text = string.Format("SubTotal = {0:c}", Convert.ToDecimal(e.Value));
            }
        }
